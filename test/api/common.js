    ...
    describe('GET /api/getPriceTicker', function() {
        it('should be ok', function(done) {
            getPriceTicker(function(err, res) {
                ...
                node.expect(res.body).to.have.deep.property('tickers.STH.BTC').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.STH.EUR').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.STH.USD').to.be.a.number;
                node.expect(res.body).to.have.deep.property('tickers.STH.CNY').to.be.a.number;
